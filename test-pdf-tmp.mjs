import { gerarHoraExtraSabadoPDF } from "./src/lib/_test-pdf.ts";
import fs from "fs";
const mk = (n, pfx) => Array.from({length:n}, (_,i)=>({nome:`${pfx} FUNCIONARIO ${String(i+1).padStart(2,"0")} TESTE SILVA`,transporte:i%2===0,alimentacao:i%3===0,presenca:i%4===0?"F":"P"}));
