...
- [Onda 2 - Gatilhos automáticos](mem://features/onda2-gatilhos-automaticos.md) — Bloco 2 do parecer CONCLUÍDO ✅: Item 1 (demissão em cascata), Item 2 (cronjob ASO 06h UTC), Item 3 (trigger mudança cargo/GHE → histórico + delta cursos + audit). Testes pendentes com Francisco anotados na feature.
