      ...
      >
        ...
        <div
          className={cn(
            ...
            overlay ? "top-14 bottom-0 z-20 shadow-2xl" : "inset-y-0 h-svh",
            side === "left"
        ...
        >
          <div
            ...
            className={cn(
              ...
              overlay &&
                "bg-sidebar/5 backdrop-blur-lg backdrop-saturate-200 border-r border-[color:var(--edge-brand)] shadow-[1px_0_0_0_var(--edge-brand)]",
            )}
          >
            {children}
          </div>
