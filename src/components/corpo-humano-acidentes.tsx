...
const POSICOES: Record<string, Pos> = {
  ...
  "Mão direita":     { x: 0.27, y: 0.53, side: "left",  short: "MÃO D",    view: "frente" },
  "Mão esquerda":    { x: 0.73, y: 0.53, side: "right", short: "MÃO E",    view: "frente" },
  "Dedos da mão":          { x: 0.23, y: 0.565, side: "left",  short: "DEDOS MÃO",   view: "frente" },
  "Dedos da mão direita":  { x: 0.23, y: 0.565, side: "left",  short: "DEDOS MÃO D", view: "frente" },
  "Dedos da mão esquerda": { x: 0.77, y: 0.565, side: "right", short: "DEDOS MÃO E", view: "frente" },
  ...
  "Ombro direito":   { x: 0.34, y: 0.28, side: "left",  short: "OMBRO D",  view: "costas" },
  "Ombro esquerdo":  { x: 0.66, y: 0.28, side: "right", short: "OMBRO E",  view: "costas" },
