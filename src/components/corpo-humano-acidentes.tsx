...
const POSICOES: Record<string, Pos> = {
  ...
  "Mão direita":     { x: 0.26, y: 0.58, side: "left",  short: "MÃO D",    view: "frente" },
  "Mão esquerda":    { x: 0.74, y: 0.58, side: "right", short: "MÃO E",    view: "frente" },
  "Dedos da mão":          { x: 0.25, y: 0.62, side: "left",  short: "DEDOS MÃO",   view: "frente" },
  "Dedos da mão direita":  { x: 0.25, y: 0.62, side: "left",  short: "DEDOS MÃO D", view: "frente" },
  "Dedos da mão esquerda": { x: 0.75, y: 0.62, side: "right", short: "DEDOS MÃO E", view: "frente" },
  ...
  "Ombro direito":   { x: 0.37, y: 0.20, side: "left",  short: "OMBRO D",  view: "costas" },
  "Ombro esquerdo":  { x: 0.63, y: 0.20, side: "right", short: "OMBRO E",  view: "costas" },
