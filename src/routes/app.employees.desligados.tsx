    ...
    <div className="p-6 md:p-8 animate-fadeIn">
      <div className="flex items-center justify-between mb-6 gap-4 flex-wrap">
        <div className="flex items-center gap-3">
          <Link to="/app/employees" className="inline-flex items-center gap-1 text-[11px] font-black uppercase tracking-widest text-muted-foreground hover:text-brand-text">
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {filtered.map((e: any) => (
            <div key={e.id} className="rounded-2xl bg-white/5 border border-white/10 p-4 shadow-sm hover:bg-white/8 transition-all relative overflow-hidden">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <Link to="/app/employees/$id" params={{ id: e.id }} className="block">
                    <h3 className="font-black text-sm text-foreground uppercase leading-tight truncate hover:text-brand-text">{e.nome}</h3>
                  </Link>
