...
const MODULO_MAP: Record<string, ModuloScope> = {
  ...
  manutencao: { slug: "manutencao", moduloLabel: "Manutenção", setor: "Manutenção", empresaFixaNome: "LF SERVIÇOS", funcionariosPermitidos: ["José Carlos Batalha", "Kleber Lucas Lima Firmino"] },
