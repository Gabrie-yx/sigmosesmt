...
export const OVERLAY_MAPS: Record<string, OverlayMap> = {
  ...
  "FOR-SEG-04": {
    ...
    fields: {
      ...
      pt_numero:    { x: 501, top: 82.3, maxW: 60, size: 4.6, bold: true, baselineOffset: 1.4, clear: { x: 499, top: 80.6, width: 62, height: 9 } },
      // Identificação
      empresa:          { x:  92, top: 162.4, maxW: 210, size: 5.4, bold: true, baselineOffset: 1.5 },
      encarregado:      { x: 392, top: 162.4, maxW: 170, size: 5.4, bold: true, baselineOffset: 1.5 },
      local_descricao:  { x: 118, top: 173.0, maxW: 444, size: 5.3, baselineOffset: 1.5 },
    ...
    checkboxes: {
      ...
      movimentacao_cargas: { cx:  44.2, cy: 104.7 },
      manutencao_civil:    { cx: 159.4, cy: 108.5 },
      gases_inflamaveis:   { cx: 251.2, cy: 104.7 },
      altura_telhados:     { cx: 329.6, cy: 104.7 },
      demolicao_escavacao: { cx: 426.6, cy: 108.3 },
      eletricidade:        { cx: 521.2, cy: 108.3 },
      trabalho_quente:     { cx:  56.0, cy: 130.7 },
      local_confinado:     { cx: 162.0, cy: 126.9 },
      outros_atividade:    { cx: 251.0, cy: 130.7 },
      // Mão-de-obra
      mao_interna:         { cx: 327.0, cy: 137.1 },
      mao_externa:         { cx: 368.0, cy: 137.1 },
      // Fim de semana / feriado
      fds_sim:             { cx: 482.0, cy: 137.1 },
      fds_nao:             { cx: 514.6, cy: 137.1 },
      // Área restrita
      area_restrita_sim:   { cx:  89.0, cy: 146.9 },
      area_restrita_nao:   { cx: 128.8, cy: 146.9 },
