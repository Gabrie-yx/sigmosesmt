...
export const OVERLAY_MAPS: Record<string, OverlayMap> = {
  ...
  "FOR-SEG-04": {
    ...
    fields: {
      ...
      assinatura_encarregado_nome: { page: 1, x: 32,  top: 620.0, maxW: 200, size: 5.6, bold: true, baselineOffset: 1.6 },
      assinatura_gerente_nome:     { page: 1, x: 238, top: 620.0, maxW: 118, size: 5.6, bold: true, baselineOffset: 1.6 },
      equipe_nome_0:   { page: 1, x: 32,  top: 463.0, maxW: 200, size: 5.4, baselineOffset: 1.6 },
      equipe_funcao_0: { page: 1, x: 238, top: 463.0, maxW: 118, size: 5.4, baselineOffset: 1.6 },
      equipe_nome_1:   { page: 1, x: 32,  top: 475.8, maxW: 200, size: 5.4, baselineOffset: 1.6 },
      equipe_funcao_1: { page: 1, x: 238, top: 475.8, maxW: 118, size: 5.4, baselineOffset: 1.6 },
      equipe_nome_2:   { page: 1, x: 32,  top: 488.6, maxW: 200, size: 5.4, baselineOffset: 1.6 },
      equipe_funcao_2: { page: 1, x: 238, top: 488.6, maxW: 118, size: 5.4, baselineOffset: 1.6 },
      equipe_nome_3:   { page: 1, x: 32,  top: 501.4, maxW: 200, size: 5.4, baselineOffset: 1.6 },
      equipe_funcao_3: { page: 1, x: 238, top: 501.4, maxW: 118, size: 5.4, baselineOffset: 1.6 },
      equipe_nome_4:   { page: 1, x: 32,  top: 514.4, maxW: 200, size: 5.4, baselineOffset: 1.6 },
      equipe_funcao_4: { page: 1, x: 238, top: 514.4, maxW: 118, size: 5.4, baselineOffset: 1.6 },
      equipe_nome_5:   { page: 1, x: 32,  top: 527.6, maxW: 200, size: 5.4, baselineOffset: 1.6 },
      equipe_funcao_5: { page: 1, x: 238, top: 527.6, maxW: 118, size: 5.4, baselineOffset: 1.6 },
      equipe_nome_6:   { page: 1, x: 32,  top: 540.8, maxW: 200, size: 5.4, baselineOffset: 1.6 },
      equipe_funcao_6: { page: 1, x: 238, top: 540.8, maxW: 118, size: 5.4, baselineOffset: 1.6 },
      equipe_nome_7:   { page: 1, x: 32,  top: 554.0, maxW: 200, size: 5.4, baselineOffset: 1.6 },
      equipe_funcao_7: { page: 1, x: 238, top: 554.0, maxW: 118, size: 5.4, baselineOffset: 1.6 },
      equipe_nome_8:   { page: 1, x: 32,  top: 567.4, maxW: 200, size: 5.4, baselineOffset: 1.6 },
      equipe_funcao_8: { page: 1, x: 238, top: 567.4, maxW: 118, size: 5.4, baselineOffset: 1.6 },
      equipe_nome_9:   { page: 1, x: 32,  top: 580.8, maxW: 200, size: 5.4, baselineOffset: 1.6 },
      equipe_funcao_9: { page: 1, x: 238, top: 580.8, maxW: 118, size: 5.4, baselineOffset: 1.6 },
      equipe_nome_10:   { page: 1, x: 32,  top: 594.0, maxW: 200, size: 5.4, baselineOffset: 1.6 },
      equipe_funcao_10: { page: 1, x: 238, top: 594.0, maxW: 118, size: 5.4, baselineOffset: 1.6 },
      equipe_nome_11:   { page: 1, x: 32,  top: 606.8, maxW: 200, size: 5.4, baselineOffset: 1.6 },
      equipe_funcao_11: { page: 1, x: 238, top: 606.8, maxW: 118, size: 5.4, baselineOffset: 1.6 },
    },
    checkboxes: {
