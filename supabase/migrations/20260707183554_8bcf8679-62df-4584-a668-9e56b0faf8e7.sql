-- C-04.b: Mudança de cargo convoca exame MUDANCA_FUNCAO automaticamente
...
BEGIN
  ...
  -- C-04.b: Convocar exame MUDANCA_FUNCAO (só se role mudou, não só GHE)
  -- Idempotente: pula se já existe PENDENTE com essa janela pra esse funcionário
  IF v_role_changed
