-- Adiciona categoria PSICOSSOCIAL ao modelo de OSS (alinha com a Matriz de Riscos
-- que tem 6 categorias e com a ficha rápida do cargo).
ALTER TABLE public.oss_templates
  ADD COLUMN IF NOT EXISTS risco_psicossocial TEXT;

-- Atualiza trigger de hash/revisão para considerar a nova coluna,
-- caso contrário mudanças nela não incrementam a revisão.
